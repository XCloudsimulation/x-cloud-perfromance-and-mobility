...
Applications run on the resources located in the \dcs{}.
The time that is necessary for serving an application request depends on the CPU speed of a hosting machine.
The capacity of a \dc{} is determined by the number of available CPUs. New instances of application are not accepted when the capacity of a \dc{} is reached.
