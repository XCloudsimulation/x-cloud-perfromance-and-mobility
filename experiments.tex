...
Times of resource allocation $T_{vm\_init}$ and release $T_{vm\_release}$ are set as measured for m1.small instance (1~vCPU, 1.7 GB of RAM and 160 GB disk) on Amazon EC2 \cite{5719609}. %http://aws.amazon.com/ec2/previous-generation/
